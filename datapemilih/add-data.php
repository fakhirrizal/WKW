            ...
            <div class="alert alert-success">
              ...
              <br>
                ...
                <div class="form-group" class="animated fadeIn mb-4">
                  <input id="nik" type="number" class="form-control" name="namapemilih" placeholder="Masukkan NIK" pattern="[0-9]{16}" title="Masukkan 16 Digit Nomor KTP Anda">
                  <br>
                  <input id="nama" type="text" class="form-control input-upper" name="namapemilih" placeholder="Nama Lengkap" title="Masukkan Nama Lengkap">
                  <br>
                  <input id="nama" type="text" class="form-control input-upper" name="namapemilih" placeholder="Tempat Lahir" title="Masukkan Tempat Lahir Anda">
                  <br>
                  <label for="exampleFormControlSelect1">Tanggal Lahir</label>
                  <input id="nama" type="date" timezone="[[timezone]]" class="form-control" name="namapemilih" placeholder="Tanggal Lahir" title="Masukkan Tempat Lahir Anda">
                  <br>
                  ...
                  <input id="nama" type="text" class="form-control input-upper" name="namapemilih" placeholder="Kecamatan" title="Kecamatan">
                  <br>
                  <input id="nama" type="text" class="form-control input-upper" name="namapemilih" placeholder="Desa / Kelurahan" title="Desa / Kelurahan">
                </div>
                <div class="row">
                  <div class="col-6">
                  <input id="rt" type="number" class="form-control" name="namapemilih" placeholder="RT" pattern="[0-9]" title="RT">
                  </div>
                  <div class="col-6">
                  <input id="rw" type="number" class="form-control" name="namapemilih" placeholder="RW" pattern="[0-9]" title="RW">
                  </div>
                </div>
                <br>
