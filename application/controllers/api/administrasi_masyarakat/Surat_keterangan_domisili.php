...
class Surat_keterangan_domisili extends REST_Controller {
	...
	function index_post() {
		...
		elseif($cek->id_desa!='3325110014'){
            ...
            $pathh = 'data_upload/dokumen/'.($get_last['id_surat_keterangan_domisili']+1).'_surat_keterangan_domisili.pdf';
			...
			$this->Main_model->log_activity($this->post('user_id'),'Adding data',"Membuat surat keterangan domisili");
			...
			if($this->db->trans_status() === false){
                ...
                $hasil['link'] = base_url().'data_upload/dokumen/'.($get_last['id_surat_keterangan_domisili']+1).'_surat_keterangan_domisili.pdf';
                $this->response($hasil, 200);
			}
		}
	}
