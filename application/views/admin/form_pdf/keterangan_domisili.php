...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0" bordercolor="#000000" width="100%" height="7">
  <tr>
    ...
    <p style="line-height: 150%"><b><font face="Arial">SURAT KETERANGAN DOMISILI</font>
    </b></td>
  </tr>
  <tr>
    <td width="100%" style="border-style: none; border-width: medium" align="center" height="1">
...
<table border="0" cellspacing="1" width="100%" style="border-width: 0" height="388">
  ...
  <tr>
    ...
    <td width="25%" style="border-style: none; border-width: medium" height="21">
    <p style="line-height: 150%"><font face="Arial">Keperluan</font> </td>
    <td width="4%" style="border-style: none; border-width: medium" height="21">
    <p style="line-height: 150%"><font face="Arial">:</font> </td>
    <td width="63%" style="border-style: none; border-width: medium" height="21">
  ...
  <tr>
    ...
    <p style="line-height: 150%">&nbsp; </td>
    <td width="4%" style="border-style: none; border-width: medium" height="21">
    <p style="line-height: 150%"><font face="Arial">h.</font> </td>
    <td width="25%" style="border-style: none; border-width: medium" height="21">
    <p style="line-height: 150%"><font face="Arial">Keterangan</font> </td>
    <td width="4%" style="border-style: none; border-width: medium" height="21">
    <p style="line-height: 150%"><font face="Arial">:</font> </td>
    <td width="63%" style="border-style: none; border-width: medium" height="21">
  ...
  <tr>
    ...
    <td width="96%" style="border-style: none; border-width: medium" colspan="4" height="21">
    <p align="justify" style="line-height: 150%"><font face="Arial">Berhubung 
