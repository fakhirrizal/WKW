		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<a href="<?php echo base_url()."admin_side/ubah_pengajuan_kk/".md5($data_utama->id_data_kk); ?>" class="btn btn-success" role="button"><i class="icon-pencil"></i> Ubah Data</a><br><br>
					<div class='row'>
						<div class="col-md-6">
							<table class="table">
								<tbody>
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/permohonan_kk"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
