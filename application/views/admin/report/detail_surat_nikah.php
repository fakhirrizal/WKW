...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/admin_side/surat_nikah'); ?>'>Pengajuan Surat Nikah</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<a href="<?php echo base_url()."admin_side/ubah_surat_nikah/".md5($data_utama->id_surat_nikah); ?>" class="btn btn-success" role="button"><i class="icon-pencil"></i> Ubah Data</a><br><br>
					<div class='row'>
						<div class="col-md-6">
							<table class="table">
                                <thead>
                        ...
                        <div class="col-md-6">
							<table class="table">
                                <thead>
                                    <tr>
										<th colspan="3"><font color='white'>.</font></th>
									</tr>
                                </thead>
								<tbody>
									<tr>
                                    ...
                                    <tr>
										<td> Keperluan </td>
										<td> : </td>
										<td><?php echo $data_utama->keperluan; ?></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/surat_nikah"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
