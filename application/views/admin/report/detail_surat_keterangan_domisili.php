		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<a href="<?php echo base_url()."admin_side/ubah_pengajuan_domisili/".md5($data_utama->id_surat_keterangan_domisili); ?>" class="btn btn-success" role="button"><i class="icon-pencil"></i> Ubah Data</a><br><br>
					<div class='row'>
						<div class="col-md-6">
							<table class="table">
								<tbody>
							...
							<table class="table">
								<tbody>
                                    ...
                                    <tr>
										<td> Keterangan </td>
										<td> : </td>
										<td><?php echo $data_utama->keterangan; ?></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/pengantar_domisili"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
