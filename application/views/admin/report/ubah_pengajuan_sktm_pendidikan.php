...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/admin_side/sktm'); ?>'>Pengajuan SKTM</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
		<span>Ubah Data</span>
		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/perbarui_pengajuan_sktm_pendidikan');?>" method="post" enctype='multipart/form-data'>
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
						<input type="hidden" name="id" value="<?= md5($data_utama->id_sktm_pendidikan); ?>">
						...
						<div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="kebangsaan" placeholder="Type something" value='<?= $data_utama->kebangsaan; ?>' required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
                            ...
                            <div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="nama_ayah" placeholder="Type something" value='<?= $data_utama->nama_ayah; ?>' required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
                            ...
                            <div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="nama_ibu" placeholder="Type something" value='<?= $data_utama->nama_ibu; ?>' required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
