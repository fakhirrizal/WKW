						...
						<div class="row">
							<div class="col-md-8">
								<div class="btn-group">
									...
									<a href="<?=base_url('admin_side/tambah_jdih');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"bProcessing": true,
								"ajax" : {
									url:"<?= site_url('admin/Master/json_jdih'); ?>"
								},
								"aoColumns": [
						        ...
						        "drawCallback": function(data) {
										...
										var id = $(this).attr("id");
										var modul = 'modul_detail_file_jdih';
										$.ajax({
											type:"POST",
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">File JDIH</h4>
