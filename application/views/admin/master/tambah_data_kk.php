...
<div class="page-content-inner">
	<div class="m-heading-1 border-yellow m-bordered" style="background-color:#FAD405;">
		...
		<p> 3. Kolom <b>Pemilik Data</b> dimaksudkan ketika ada pengguna yang masuk ke dalam sistem maka data ini masuk dalam rekapan data pengguna tersebut.</p>
	</div>
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/ajukan_permohonan_kk');?>" method="post" enctype='multipart/form-data'>
