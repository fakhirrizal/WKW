			...
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<div class='row'>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <div class="btn-group" style="text-align: center;">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_anggota_lembaga_desa/'.md5($value->id_anggota_lembaga_desa)).'">
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/lembaga_desa"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box box-primary" >
                    <form role="form" class="form-horizontal" action="<?=base_url('admin_side/simpan_data_anggota_lembaga_desa');?>" method="post" enctype='multipart/form-data'>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box box-primary" >
                    <form role="form" class="form-horizontal" action="<?=base_url('admin_side/perbarui_data_lembaga_desa');?>" method="post" enctype='multipart/form-data'>
                        <input type="hidden" name="id_" value='<?= $data_utama->id_lembaga_desa; ?>'>
                        <div class="form-body">
                            <div class="form-group form-md-line-input has-danger">
