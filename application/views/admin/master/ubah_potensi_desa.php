		...
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/perbarui_potensi_desa');?>" method="post" enctype='multipart/form-data'>
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
						<input type="hidden" name="id" value="<?= md5($data_utama->id_potensi_desa); ?>">
						<div class="form-body">
                            ...
                            <div class="form-group form-md-line-input has-danger">
                                ...
                                <div class="col-md-10">
                                   <img src='<?=base_url('data_upload/potensi_desa/'.$data_utama->foto);?>' width='100px'/>
                                </div>
                            </div>
						</div>
						<br>
