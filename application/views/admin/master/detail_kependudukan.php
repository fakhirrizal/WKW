			...
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<div class='row'>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <div class="btn-group" style="text-align: center;">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_item_data_kependudukan/'.md5($value->id)).'">
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/data_kependudukan"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box box-primary" >
                    <form role="form" class="form-horizontal" action="<?=base_url('admin_side/simpan_data_rincian_kependudukan');?>" method="post" enctype='multipart/form-data'>
                        <div class="form-body">
