...
<![endif]-->
        ...
        <script src="<?=base_url('assets_dashboard/global/scripts/datatable.js');?>" type="text/javascript"></script>
        <script src="<?=base_url('assets_dashboard/global/plugins/datatables/datatables.min.js');?>" type="text/javascript"></script>
        <script src="<?=base_url('assets_dashboard/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js');?>" type="text/javascript"></script>
        ...
        <script src="<?=base_url('assets_dashboard/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js');?>" type="text/javascript"></script>
		...
		<script src="<?=base_url('assets_dashboard/pages/scripts/table-datatables-editable.min.js');?>" type="text/javascript"></script>
		<script src="<?=base_url('assets_dashboard/pages/scripts/form-wizard.min.js');?>" type="text/javascript"></script>
		<script src="<?=base_url('assets_dashboard/pages/scripts/ui-buttons.min.js');?>" type="text/javascript"></script>
		<script src="<?=base_url('assets_dashboard/pages/scripts/ui-blockui.min.js');?>" type="text/javascript"></script>
