                                                                ...
                                                                <td style="text-align: center;">
                                                                    <div class="btn-group" style="text-align: center;">
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            ...
                                                                            <li>
                                                                                <a onclick="'.$return_on_click.'" href="'.site_url('hapus_sub_output/'.md5($value->id_sub_output)).'">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box box-primary" >
                    <form role="form" class="form-horizontal" action="<?=base_url('simpan_detail_anggaran');?>" method="post" enctype='multipart/form-data'>
