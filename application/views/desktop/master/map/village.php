						...
						<div class="row">
							<div class="col-md-6">
								<div class="btn-group">
									...
									<a href="<?=base_url('tambah_data_kelurahan');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript">
						$(document).ready(function() {
							...
							var t = $("#mytable").dataTable({
								...
								processing: true,
								serverSide: true,
								ajax: {"url":"<?= site_url('desktop/Map/json_peta_kelurahan'); ?>", "type": "POST"},
								columns: [
									{
										"data": "id_desa",
