...
<div id="cssload">
  ...
  <img src="<?= base_url(); ?>/assets/img/other/banner-adm.png" class="img-fluid w-100" alt="">
  <div class="container">
    <h5 class="card-title p-3">Administrasi Masyarakat</h5>
    <div class="card">
      <!-- Card content -->
      <div class="card-body">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row text-center">
          ...
          <div class="col-4">
            <i class="far fa-file fa-3x yellow-text"></i>
            <div class="fa-sm">Surat Keterangan Usaha</div>
          </div>
          <div class="col-4">
            <i class="far fa-file fa-3x yellow-text"></i>
            <div class="fa-sm">Surat Keterangan Tidak Mampu</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row text-center">
          ...
          <div class="col-4">
            <i class="far fa-file fa-3x yellow-text"></i>
            <div class="fa-sm">Permohonan Nikah</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row text-center">
          <div class="col-4">
            <i class="far fa-file fa-3x yellow-text"></i>
            <div class="fa-sm">Laporan Kematian Penduduk</div>
          </div>
          <div class="col-4">
            <i class="far fa-file fa-3x yellow-text"></i>
            <div class="fa-sm">Laporan Kelahiran Penduduk</div>
          </div>
          <div class="col-4">
            <i class="far fa-file fa-3x yellow-text"></i>
            <div class="fa-sm">Perpindahan Penduduk</div>
          </div>
        </div>
      </div>
    </div>
