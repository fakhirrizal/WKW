...
<script type="text/javascript">
	function getPageWO() {
		$('#halaman_kependudukan').html('<img src="https://wpamelia.com/wp-content/uploads/2018/11/ezgif-2-6d0b072c3d3f.gif" />');
		var modul = 'kependudukan';
		jQuery.ajax({
			url: "<?php echo site_url(); ?>mobile/App/ajax_page",
			data: {modul:modul},
			type: "POST",
			success:function(data){
				$('#halaman_kependudukan').html(data);
				$("#loading-image").hide();
			}
		});
	}
